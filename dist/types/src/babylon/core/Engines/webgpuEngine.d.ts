...
export declare class WebGPUEngine extends ThinWebGPUEngine {
    ...
    createTextureNoUrl(size: TextureSize, noMipmapOrOptions: boolean | ITextureCreationOptions, invertY: boolean, premultiplyAlpha: boolean, samplingMode: number, buffer: ArrayBuffer | ImageBitmap | HTMLImageElement, format: number): Texture;
}
export {};
