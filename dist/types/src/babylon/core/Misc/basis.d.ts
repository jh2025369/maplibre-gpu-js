 ...
 */
export declare const GetInternalFormatFromBasisFormat: (basisFormat: number, engine: AbstractEngine) => any;
/**
...
export declare const BasisTools: {
     ...
     * @returns internal format corresponding to the Basis format
     */
    GetInternalFormatFromBasisFormat: (basisFormat: number, engine: AbstractEngine) => any;
    /**
     * Transcodes a loaded image file to compressed pixel data
     * @param data image data to transcode
     * @param config configuration options for the transcoding
