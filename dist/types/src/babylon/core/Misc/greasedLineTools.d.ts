...
export declare class GreasedLineTools {
     ...
     */
    static OmitZeroLengthPredicate(p1: Vector3, p2: Vector3, p3: Vector3): any[];
    /**
     ...
     * @returns original points or null if any edge length is zero
     */
    static OmitDuplicatesPredicate(p1: Vector3, p2: Vector3, p3: Vector3, points: Vector3[][]): any[];
     ...
     */
    static GetPointsFromText(text: string, size: number, resolution: number, fontData: IFontData, z?: number, includeInner?: boolean): any[];
    /**
