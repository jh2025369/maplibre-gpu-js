...
export declare class NodeMaterial extends PushMaterial {
     ...
     */
    getBlockByName(name: string): any;
    /**
     * Get a block using a predicate
     * @param predicate defines the predicate used to find the good candidate
     * @returns the required block or null if not found
     */
    getBlockByPredicate(predicate: (block: NodeMaterialBlock) => boolean): NodeMaterialBlock;
    /**
     ...
     */
    registerOptimizer(optimizer: NodeMaterialOptimizer): this;
    /**
     * Remove an optimizer from the list of optimizers
     * @param optimizer defines the optimizers to remove
     * @returns the current material
     */
    unregisterOptimizer(optimizer: NodeMaterialOptimizer): this;
    /**
