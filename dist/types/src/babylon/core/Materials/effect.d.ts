...
import type { ShaderCustomProcessingFunction, _IShaderProcessingContext } from "../Engines/Processors/shaderProcessingOptions";
...
export declare class Effect implements IDisposable {
    ...
    shaderProcessorCustom: Nullable<IShaderProcessor>;
    /**
