...
export declare class Texture extends BaseTexture {
    ...
    /** @internal */
    _buffer: Nullable<string | ArrayBuffer | ArrayBufferView | HTMLImageElement | Blob | ImageBitmap | ArrayBufferLike>;
