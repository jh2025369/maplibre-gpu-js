...
export declare class VertexData implements IVertexDataLike {
     ...
     * @internal
     */
    _applyToCoroutine(meshOrGeometry: IGetSetVerticesData, updatable: boolean, isAsync: boolean): Coroutine<VertexData>;
    private _update;
    ...
    _mergeCoroutine(transform: Matrix | undefined, vertexDatas: {
        ...
        transform?: Matrix;
    }[], use32BitsIndices: boolean, isAsync: boolean, forceCloneIndices: boolean, mergeMaterialIds?: boolean, enableCompletion?: boolean): Coroutine<VertexData>;
