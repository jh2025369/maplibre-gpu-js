...
export declare class Vector2 implements Vector<Tuple<number, 2>, IVector2Like>, IVector2Like {
     ...
     */
    static _V8PerformanceHack: import("../types").DeepImmutableObject<Vector2>;
     ...
     */
    static RandomToRef<T extends Vector2>(min: number, max: number, ref: T): T;
    /**
...
export declare class Vector3 implements Vector<Tuple<number, 3>, Vector3LikeInternal>, IVector3Like {
     ...
     */
    static _V8PerformanceHack: import("../types").DeepImmutableObject<Vector3>;
     ...
     * @returns the ref with random values between min and max
     */
    static RandomToRef<T extends Vector3>(min: number, max: number, ref: T): T;
    /**
...
export declare class Vector4 implements Vector<Tuple<number, 4>, IVector4Like>, IVector4Like {
     ...
     */
    static _V8PerformanceHack: import("../types").DeepImmutableObject<Vector4>;
    private static _ZeroReadOnly;
    /**
     * @see Tensor.dimension
     */
     ...
     * @returns the ref with random values between min and max
     */
    static RandomToRef<T extends IVector4Like>(min: number, max: number, ref: T): T;
    /**
...
export declare class Quaternion implements Tensor<Tuple<number, 4>, Quaternion>, IQuaternionLike {
     ...
     */
    static _V8PerformanceHack: import("../types").DeepImmutableObject<Quaternion>;
    /** @internal */
    _x: number;
    /** @internal */
    _y: number;
     ...
     * @returns the ref with random values between min and max
     */
    static RandomToRef<T extends Quaternion>(min: number, max: number, ref: T): T;
    /**
     * Do not use
     * @internal
     */
