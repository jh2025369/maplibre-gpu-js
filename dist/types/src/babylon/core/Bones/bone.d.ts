...
export declare class Bone extends Node {
     ...
     */
    getPositionToRef(space: Space, tNode: Nullable<TransformNode>, result: Vector3): void;
    /**
     ...
     */
    getDirectionToRef(localAxis: Vector3, tNode: Nullable<TransformNode>, result: Vector3): void;
    /**
     ...
     */
    getRotationToRef(space: Space, tNode: Nullable<TransformNode>, result: Vector3): void;
    /**
     ...
     */
    getRotationQuaternionToRef(space: Space, tNode: Nullable<TransformNode>, result: Quaternion): void;
    /**
     ...
     */
    getRotationMatrix(space: Space, tNode: TransformNode): Matrix;
    /**
     ...
     * @param result The quaternion that the rotation should be copied to
     */
    getRotationMatrixToRef(space: Space, tNode: TransformNode, result: Matrix): void;
    /**
     ...
     */
    getAbsolutePositionFromLocalToRef(position: Vector3, tNode: Nullable<TransformNode>, result: Vector3): void;
    /**
     ...
     */
    getLocalPositionFromAbsoluteToRef(position: Vector3, tNode: Nullable<TransformNode>, result: Vector3): void;
    /**
