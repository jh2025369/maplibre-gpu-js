 ...
 */
type CustomRenderMethod = (painter: Painter, matrix: mat4) => void;
...
export interface CustomLayerInterface {
     ...
     */
    onAdd?(map: Map, engine: WebGPUEngine): void;
    /**
     ...
     * @param gl - The gl context for the map.
     */
    onRemove?(map: Map, engine: WebGPUEngine): void;
}
...
export class CustomStyleLayer extends StyleLayer {
    ...
    onAdd = (map: Map) => {
        if (this.implementation.onAdd) {
            this.implementation.onAdd(map, map.painter.engine);
        }
    };

    onRemove = (map: Map) => {
        if (this.implementation.onRemove) {
            this.implementation.onRemove(map, map.painter.engine);
        }
    };
}
