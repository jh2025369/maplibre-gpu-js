...
export class UniformBuffer {
    ...
    public _buffer: Nullable<DataBuffer>;
    public _buffers: Array<[DataBuffer, Float32Array | undefined]>;
    public _bufferIndex: number;
    private _createBufferOnWrite: boolean;
    public _data: number[];
    public _bufferData: Float32Array;
