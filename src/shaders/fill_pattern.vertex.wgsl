...
fn main(input: VertexInput) -> VertexOutput {
    ...
    output.v_pos_a = get_pattern_pos(uniforms.u_pixel_coord_upper, uniforms.u_pixel_coord_lower, fromScale * display_size_a, tileZoomRatio, input.a_pos);
    output.v_pos_b = get_pattern_pos(uniforms.u_pixel_coord_upper, uniforms.u_pixel_coord_lower, toScale * display_size_b, tileZoomRatio, input.a_pos);
