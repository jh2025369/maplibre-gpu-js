...
export class FullscreenControl extends Evented implements IControl {
    ...
    onAdd(map: Map): HTMLElement {
        ...
        this._controlContainer = DOM.create('div', 'maplibregpu-ctrl maplibregpu-ctrl-group');
        this._setupUI();
    ...
    _setupUI() {
        const button = this._fullscreenButton = DOM.create('button', (('maplibregpu-ctrl-fullscreen')), this._controlContainer);
        DOM.create('span', 'maplibregpu-ctrl-icon', button).setAttribute('aria-hidden', 'true');
        button.type = 'button';
        this._updateTitle();
    ...
    _handleFullscreenChange() {
        ...
        this._fullscreenButton.classList.toggle('maplibregpu-ctrl-shrink');
        this._fullscreenButton.classList.toggle('maplibregpu-ctrl-fullscreen');
        this._updateTitle();
    ...
    _togglePseudoFullScreen() {
        this._container.classList.toggle('maplibregpu-pseudo-fullscreen');
        this._handleFullscreenChange();
        this._map.resize();
    }
}
