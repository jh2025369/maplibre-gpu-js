...
describe('TerrainControl', () => {
    test('appears in top-right by default', () => {
        ...
        expect(
            map.getContainer().querySelectorAll('.maplibregpu-ctrl-top-right .maplibregpu-ctrl-terrain')
        ).toHaveLength(1);
    });
    ...
    test('appears in the position specified by the position option', () => {
        ...
        expect(
            map.getContainer().querySelectorAll('.maplibregpu-ctrl-bottom-right .maplibregpu-ctrl-terrain')
        ).toHaveLength(1);
