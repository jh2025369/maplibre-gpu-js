...
export class BoxZoomHandler implements Handler {
    ...
    mousemoveWindow(e: MouseEvent, point: Point) {
        ...
        if (!this._box) {
            this._box = DOM.create('div', 'maplibregpu-boxzoom', this._container);
            this._container.classList.add('maplibregpu-crosshair');
    ...
    reset() {
        ...
        this._container.classList.remove('maplibregpu-crosshair');
