...
export class CooperativeGesturesHandler implements Handler {
    ...
    _setupUI() {
        ...
        mapCanvasContainer.classList.add('maplibregpu-cooperative-gestures');
        this._container = DOM.create('div', 'maplibregpu-cooperative-gesture-screen', mapCanvasContainer);
        ...
        desktopDiv.className = 'maplibregpu-desktop-message';
        ...
        mobileDiv.className = 'maplibregpu-mobile-message';
    ...
    _destoryUI() {
        if (this._container) {
            ...
            const mapCanvasContainer = this._map.getCanvasContainer();
            mapCanvasContainer.classList.remove('maplibregpu-cooperative-gestures');
        }
    ...
    _onCooperativeGesture(showNotification: boolean) {
        ...
        this._container.classList.add('maplibregpu-show');
        setTimeout(() => {
            this._container.classList.remove('maplibregpu-show');
        }, 100);
    }
}
