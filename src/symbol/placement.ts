...
export class Placement {
    ...
    updateBucketOpacities(bucket: SymbolBucket, seenCrossTileIDs: {
        ...
        if (bucket.hasTextData() && bucket.text.opacityVertexBuffer) {
            bucket.engine.updateDynamicVertexBuffer(bucket.text.opacityVertexBuffer, bucket.text.opacityVertexArray.arrayBuffer);
        }
        if (bucket.hasIconData() && bucket.icon.opacityVertexBuffer) {
            bucket.engine.updateDynamicVertexBuffer(bucket.icon.opacityVertexBuffer, bucket.icon.opacityVertexArray.arrayBuffer);
        }
        if (bucket.hasIconCollisionBoxData() && bucket.iconCollisionBox.collisionVertexBuffer) {
            bucket.engine.updateDynamicVertexBuffer(bucket.iconCollisionBox.collisionVertexBuffer, bucket.iconCollisionBox.collisionVertexArray.arrayBuffer);
        }
