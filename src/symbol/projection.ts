...
function updateLineLabels(bucket: SymbolBucket,
    ...
    if (isText) {
        bucket.engine.updateDynamicVertexBuffer(bucket.text.dynamicLayoutVertexBuffer, dynamicLayoutVertexArray.arrayBuffer);
    } else {
        bucket.engine.updateDynamicVertexBuffer(bucket.icon.dynamicLayoutVertexBuffer, dynamicLayoutVertexArray.arrayBuffer);
    }
}
